...
router.post('/webhook', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, signature, tx, err_1, msg;
...
// ---------------------------------------------------------------------------
router.post('/register-webhook', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                url = req.body.url;
                if (!url)
                    return [2 /*return*/, res.status(400).json({ success: false, message: 'URL required' })];
                return [4 /*yield*/, kotani.registerWebhook(url)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
